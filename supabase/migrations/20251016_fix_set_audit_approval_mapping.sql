-- Fix set_audit_approval auth mapping: compare branch manager assignments via public.users.auth_user_id
-- Also fix self-approval guard to map assigned_to (app user id) to auth.uid()
