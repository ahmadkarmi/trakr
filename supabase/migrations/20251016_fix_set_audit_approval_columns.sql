-- Fix set_audit_approval to use correct column names on audits table
-- approval_signature_url + approval_signature_type (not approval_signature / signature_type)
