...
# Replace the comment and div on lines 359-360
$content = $content.Replace(
  '                  {/* Enhanced Mobile Audit Cards */}' + "`n" +
  '                  <div className="grid gap-6 md:hidden">',
  '                  {/* Compact Mobile Cards */}' + "`n" +
  '                  <div className="space-y-3 md:hidden">'
)

# Replace the entire card structure
$content = $content.Replace(
...
Write-Host "✅ Successfully updated mobile cards!" -ForegroundColor Green
