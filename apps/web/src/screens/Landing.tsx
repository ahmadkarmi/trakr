          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Pricing</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Contact</a></li>
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Careers</a></li>
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Blog</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Documentation</a></li>
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Help Center</a></li>
                <li><a href="#beta" className="text-sm text-gray-600 hover:text-primary-600 transition-colors">Privacy Policy</a></li>
              </ul>
            </div>
          </div>
